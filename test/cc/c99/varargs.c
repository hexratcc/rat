...
int main() {
  ...
  // C99 6.5.2.2p6: a float argument to a variadic function is promoted to
  // double, so it must be read back with va_arg(ap, double).
  ASSERT(10, ({ float f = 2.0f; sum2(1, f, 3, 4.0, 0); }));
