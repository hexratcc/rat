...
namespace rat {
	...
	enum Cc : U8 {
		CC_B = 0x2, CC_AE = 0x3, CC_E = 0x4, CC_NE = 0x5,
		CC_BE = 0x6, CC_A = 0x7, CC_L = 0xc, CC_LE = 0xe,
	};
	...
	struct Asm {
		...
		Asm(List<U8>& c, List<AsmReloc>& r) : code(c), relocs(r) {}
		...
		void idivReg(Reg r) { unaryF7(7, r); }
		void divReg(Reg r) { unaryF7(6, r); }
		void cqo() {
			rex(true, 0, 0, 0);
			b(0x99);
		}
		...
		void faddp() { b(0xde); b(0xc1); }
		void fsubp() { b(0xde); b(0xe9); }
		void fmulp() { b(0xde); b(0xc9); }
		void fdivp() { b(0xde); b(0xf9); }
		void fchs() { b(0xd9); b(0xe0); }
		void fucomip() { b(0xdf); b(0xe9); }
		void fstpReg0() { b(0xdd); b(0xd8); }
	};
} // namespace rat
